...
WORDLIST_FILENAME = "D:/Works/course/6.0001/MIT-6.0001/exercise/PS3/PS3/words.txt"
...
def get_word_score(word, n):
    ...
    scores = component_1 * component_2
    return scores
#
...
def update_hand(hand, word):
    ...
    new_hand = hand.copy()
    # remove char in the hand dict if it exists
    word = str.lower(word)
    for letter in word:
...
def is_valid_word(word, hand, word_list):
    ...
    word = str.lower(word)
    hand_copy = hand.copy()
    # if word composed of letters in the hand
    for letter in word:
      # if current letter is a wildcard
    ...
    if word not in word_list:
        ...
        if wildcard_pos == -1:
            ...
            for vowel in VOWELS:
               temp_word = word[:wildcard_pos] + vowel + word[wildcard_pos+1:]
    ...
    while (any(hand.values())):
        ...
        # Otherwise (the input is not two exclamation points):
            ...
            if is_valid_word(input_word,hand,word_list):
                ...
                print(f"{input_word} earns {current_score} points. Total: {total_score} points")
